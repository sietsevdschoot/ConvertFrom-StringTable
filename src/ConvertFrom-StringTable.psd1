...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('ConvertFrom','ConvertFrom-StringTable','ConvertFrom-String','ConvertFrom-Table','PSEdition_Core','Windows','Linux','MacOS','stringtable','Parse','Docker','Kubernetes')

        # A URL to the license for this module.
        LicenseUri = 'https://raw.githubusercontent.com/sietsevdschoot/ConvertFrom-StringTable/main/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/sietsevdschoot/ConvertFrom-StringTable'
